# Paraphrase Regression Report paraphrase_gold5y_20260312_1241
...
- `audit_response` ok=1 needs_review=2 high_risk=1
- `contract_review` ok=0 needs_review=1 high_risk=2
- `hr_admin` ok=1 needs_review=1 high_risk=1
- `procurement_bid` ok=0 needs_review=2 high_risk=1
- `project_management` ok=0 needs_review=3 high_risk=0
- `standard` ok=0 needs_review=2 high_risk=0

## High Risk Cases

- `five_year_employee_hr_admin_02_08666670` [hr_admin] 승진 권고를 위한 추천서 작성 시 어떤 기준과 양식을 따라야 하나요
  status=high_risk template=- confidence=low similarity=0.1424 retrieval_f1=0.9333
  citation_panel_clean=True citations=7 referenced=7
  ...
  current_ids=['43309a76ff174026a8c9b330a7485f53::구간 114', '43309a76ff174026a8c9b330a7485f53::구간 113', '43309a76ff174026a8c9b330a7485f53::구간 143', '99f005f4ecc74f57bcb4476f081b4c19::구간 314']
- `five_year_employee_contract_review_01_11017db6` [contract_review] 계약서에 명시된 위약금 조항의 적용 범위와 절차는 어떻게 되나요
  status=high_risk template=- confidence=low similarity=0.2625 retrieval_f1=0.8000
...
- `five_year_employee_audit_response_04_a01c72d3` [audit_response] 환수 위험을 피하기 위해 지원금 지출 시 어떤 증빙을 확보해야 하나요
  status=high_risk template=- confidence=low similarity=0.3731 retrieval_f1=0.8889
...
- `five_year_employee_procurement_bid_03_fe5f284e` [procurement_bid] 계약 체결 전 검토해야 할 주요 조항과 해당 조항의 위험 요소는 무엇인가요
  status=high_risk template=- confidence=low similarity=0.3901 retrieval_f1=0.8889
  citation_panel_clean=True citations=4 referenced=4
  ...
  current_ids=['7dc540f5efd6451c903a515e960ffc23::구간 56', '99f005f4ecc74f57bcb4476f081b4c19::구간 576', '99f005f4ecc74f57bcb4476f081b4c19::구간 445', 'f6f2c8b2e0df4d65a382daafa6e41560::구간 76']
- `five_year_employee_contract_review_03_d92271d8` [contract_review] 대금 지급을 위한 증빙이 누락될 경우 어떤 절차를 따라야 하나요
  status=high_risk template=- confidence=low similarity=0.4489 retrieval_f1=0.8889
  citation_panel_clean=True citations=4 referenced=4
  ...
  current_ids=['cae8e105770b432c9cba14d3f73e7915::구간 70', '8654bda6ea7a4b49ad8eb28b4692cbe6::구간 20', 'cae8e105770b432c9cba14d3f73e7915::구간 82', 'cae8e105770b432c9cba14d3f73e7915::구간 56']

## Needs Review Cases

- `five_year_employee_standard_02_0ba0dcce` [standard] 사업비 집행 시 원가 계산 및 증빙 서류는 어떤 기준을 따라야 하나요
  status=needs_review template=- confidence=low similarity=0.4981 retrieval_f1=0.7500
...
- `five_year_employee_procurement_bid_02_41864b68` [procurement_bid] 예정가격 설정 기준에 따라 가격 책정 시 유의해야 할 사항은 무엇인가요
  status=needs_review template=- confidence=medium similarity=0.5232 retrieval_f1=0.5714
...
- `five_year_employee_hr_admin_03_5ae23cad` [hr_admin] 근무 태도 징계 시 참고해야 할 규정과 절차는 무엇인지 확인할 수 있을까요
  status=needs_review template=- confidence=low similarity=0.5315 retrieval_f1=0.8889
  citation_panel_clean=True citations=4 referenced=4
  ...
  current_ids=['1c722f2453a646aea4a6477d99eb573f::구간 328', '1c722f2453a646aea4a6477d99eb573f::구간 326', '43309a76ff174026a8c9b330a7485f53::구간 174', '99f005f4ecc74f57bcb4476f081b4c19::구간 252']
- `five_year_employee_audit_response_03_7113aa6a` [audit_response] 사업비 정산 시 필수로 제출해야 하는 증빙 서류 목록은 무엇인지 확인할 수 있을까요
  status=needs_review template=- confidence=low similarity=0.5630 retrieval_f1=0.7692
  citation_panel_clean=True citations=5 referenced=5
...
- `five_year_employee_standard_01_2f2855b6` [standard] 교육훈련 규칙에 따라 직원 교육 계획 수립 시 반드시 포함해야 할 항목은 무엇인가요
  status=needs_review template=- confidence=low similarity=0.6162 retrieval_f1=0.8889
  citation_panel_clean=True citations=4 referenced=4
...
- `five_year_employee_project_management_02_73f9ae43` [project_management] 결과보고 시 포함해야 할 주요 항목과 제출 기한은 어떻게 되나요
  status=needs_review template=- confidence=low similarity=0.6634 retrieval_f1=0.7500
  citation_panel_clean=True citations=3 referenced=3
...
- `five_year_employee_project_management_01_3710ec10` [project_management] 사업비 집행 전 반드시 확인해야 할 증빙 서류 목록은 무엇인가요
  status=needs_review template=- confidence=low similarity=0.6850 retrieval_f1=0.7692
  citation_panel_clean=True citations=5 referenced=5
  ...
  current_ids=['ac1edc218c3347b5859d4c56e94a067b::구간 10', 'cae8e105770b432c9cba14d3f73e7915::구간 69', 'cae8e105770b432c9cba14d3f73e7915::구간 70', 'cae8e105770b432c9cba14d3f73e7915::구간 56']
- `five_year_employee_project_management_03_1e783e09` [project_management] 정산 과정에서 보완해야 할 서류나 절차가 있다면 어떤 것들이 있나요
  status=needs_review template=- confidence=low similarity=0.7365 retrieval_f1=0.5714
  citation_panel_clean=True citations=2 referenced=2
