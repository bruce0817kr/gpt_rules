# Paraphrase Regression Report paraphrase_gold5y_20260312_1255
...
- `five_year_employee_audit_response_04_a01c72d3` [audit_response] 환수 위험을 피하기 위해 지원금 지출 시 어떤 증빙을 확보해야 하나요
  status=high_risk template=- confidence=low similarity=0.3774 retrieval_f1=0.8889
...
- `five_year_employee_project_management_01_3710ec10` [project_management] 사업비 집행 전 반드시 확인해야 할 증빙 서류 목록은 무엇인가요
  status=needs_review template=- confidence=low similarity=0.6834 retrieval_f1=0.6667
  citation_panel_clean=True citations=4 referenced=4
...
- `five_year_employee_standard_01_2f2855b6` [standard] 교육훈련 규칙에 따라 직원 교육 계획 수립 시 반드시 포함해야 할 항목은 무엇인가요
  status=needs_review template=- confidence=low similarity=0.7087 retrieval_f1=0.7500
  ...
  current_ids=['99f005f4ecc74f57bcb4476f081b4c19::구간 270', 'dcccf0db3cf44121a69a2dea53ac0003::구간 8', 'dcccf0db3cf44121a69a2dea53ac0003::구간 6']
- `five_year_employee_audit_response_03_7113aa6a` [audit_response] 사업비 정산 시 필수로 제출해야 하는 증빙 서류 목록은 무엇인지 확인할 수 있을까요
  status=needs_review template=- confidence=low similarity=0.7095 retrieval_f1=0.6667
  citation_panel_clean=True citations=4 referenced=4
...
- `five_year_employee_project_management_03_1e783e09` [project_management] 정산 과정에서 보완해야 할 서류나 절차가 있다면 어떤 것들이 있나요
  status=needs_review template=- confidence=low similarity=0.8142 retrieval_f1=0.5714
