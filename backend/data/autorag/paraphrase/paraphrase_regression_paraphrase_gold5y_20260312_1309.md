# Paraphrase Regression Report paraphrase_gold5y_20260312_1309
...
- `five_year_employee_project_management_03_1e783e09` [project_management] 정산 과정에서 보완해야 할 서류나 절차가 있다면 어떤 것들이 있나요
  status=needs_review template=- confidence=low similarity=0.8486 retrieval_f1=0.5714
...
- `five_year_employee_standard_02_0ba0dcce` [standard] 사업비 집행 시 원가 계산 및 증빙 서류는 어떤 기준을 따라야 하나요
  status=needs_review template=expense_evidence_rule confidence=low similarity=0.9832 retrieval_f1=0.7692
...
- `five_year_employee_audit_response_03_7113aa6a` [audit_response] 사업비 정산 시 필수로 제출해야 하는 증빙 서류 목록은 무엇인지 확인할 수 있을까요
  status=needs_review template=audit_expense_settlement_list confidence=low similarity=0.9901 retrieval_f1=0.7692
...
- `five_year_employee_project_management_02_73f9ae43` [project_management] 결과보고 시 포함해야 할 주요 항목과 제출 기한은 어떻게 되나요
  status=needs_review template=project_result_report_timeline confidence=low similarity=0.9949 retrieval_f1=0.5000
  ...
  current_ids=['214a173629da433d8b4d97fba5032780::구간 64', 'dcccf0db3cf44121a69a2dea53ac0003::구간 42', '43309a76ff174026a8c9b330a7485f53::구간 422']
