# Paraphrase Regression Report paraphrase_gold5y_20260312_1324
...
- `audit_response` ok=3 needs_review=1 high_risk=0
- `contract_review` ok=2 needs_review=0 high_risk=1
- `hr_admin` ok=3 needs_review=0 high_risk=0
- `procurement_bid` ok=2 needs_review=0 high_risk=1
...
- `five_year_employee_procurement_bid_01_e0e33251` [procurement_bid] 입찰에 필요한 비교견적 제출 시 요구되는 서류 목록은 무엇인가요
  status=high_risk template=procurement_quote_documents confidence=low similarity=0.1162 retrieval_f1=0.8571
  ...
  current_ids=['8e169ef54945417a9cf4799722f7f0c4::구간 68', '3aa3e8b396504bbda35e8b958a163f4a::구간 73', 'cae8e105770b432c9cba14d3f73e7915::구간 56', 'a116034c047b4c3fb897903f9598593d::구간 14']
- `five_year_employee_contract_review_02_80f5ca27` [contract_review] 계약 변경 사항을 승인받기 위해 반드시 첨부해야 하는 서류는 무엇인가요
  status=high_risk template=contract_change_documents confidence=low similarity=0.1749 retrieval_f1=0.6667
  ...
  current_ids=['00d855d4747048dda6da29b95e300646::구간 29', '00d855d4747048dda6da29b95e300646::구간 28', '1141dfe95b47437fb09b5a88aace0e28::구간 20', '1141dfe95b47437fb09b5a88aace0e28::구간 26']

## Needs Review Cases

- `five_year_employee_audit_response_01_7469eb85` [audit_response] 법인카드 사용 후 증빙 서류는 어떤 형식으로 제출해야 하며, 누락 시 어떤 위험이 있을까요
  status=needs_review template=corp_card_policy confidence=low similarity=0.4761 retrieval_f1=0.6667
  ...
  current_ids=['cae8e105770b432c9cba14d3f73e7915::구간 219', 'cae8e105770b432c9cba14d3f73e7915::구간 362', '877ad38b63324f48953489f933e61ca2::구간 12', 'ac1edc218c3347b5859d4c56e94a067b::구간 45']
- `five_year_employee_project_management_03_1e783e09` [project_management] 정산 과정에서 보완해야 할 서류나 절차가 있다면 어떤 것들이 있나요
  status=needs_review template=project_settlement_missing_docs confidence=low similarity=0.5223 retrieval_f1=0.5714
...
- `five_year_employee_project_management_02_73f9ae43` [project_management] 결과보고 시 포함해야 할 주요 항목과 제출 기한은 어떻게 되나요
  status=needs_review template=project_result_report_timeline confidence=low similarity=0.8968 retrieval_f1=0.6667
  citation_panel_clean=True citations=7 referenced=7
  ...
  current_ids=['214a173629da433d8b4d97fba5032780::구간 64', 'dcccf0db3cf44121a69a2dea53ac0003::구간 42', '43309a76ff174026a8c9b330a7485f53::구간 422', '214a173629da433d8b4d97fba5032780::구간 66']
- `five_year_employee_standard_02_0ba0dcce` [standard] 사업비 집행 시 원가 계산 및 증빙 서류는 어떤 기준을 따라야 하나요
  status=needs_review template=expense_evidence_rule confidence=low similarity=0.9805 retrieval_f1=0.7692
  citation_panel_clean=True citations=8 referenced=8
  ...
  current_ids=['ac1edc218c3347b5859d4c56e94a067b::구간 10', 'cae8e105770b432c9cba14d3f73e7915::구간 311', 'cae8e105770b432c9cba14d3f73e7915::구간 70', 'cae8e105770b432c9cba14d3f73e7915::구간 86']
- `five_year_employee_project_management_01_3710ec10` [project_management] 사업비 집행 전 반드시 확인해야 할 증빙 서류 목록은 무엇인가요
  status=needs_review template=project_expense_evidence_list confidence=low similarity=0.9896 retrieval_f1=0.6667
  citation_panel_clean=True citations=4 referenced=4
  ...
  current_ids=['ac1edc218c3347b5859d4c56e94a067b::구간 10', 'cae8e105770b432c9cba14d3f73e7915::구간 69', '1141dfe95b47437fb09b5a88aace0e28::구간 26', 'ac1edc218c3347b5859d4c56e94a067b::구간 45']
