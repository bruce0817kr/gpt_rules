# Paraphrase Regression Report paraphrase_gold5y_20260312_1336
...
- `procurement_bid` ok=2 needs_review=1 high_risk=0
...
- `five_year_employee_project_management_03_1e783e09` [project_management] 정산 과정에서 보완해야 할 서류나 절차가 있다면 어떤 것들이 있나요
  status=needs_review template=- confidence=low similarity=0.7420 retrieval_f1=0.5714
