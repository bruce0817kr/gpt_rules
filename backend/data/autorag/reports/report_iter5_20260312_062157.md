# Ralph Loop Report iter5_20260312_062157

- Generated at (UTC): 2026-03-11T21:24:13.116051+00:00
- Retrieval F1 with reranker: 1.0000
- Retrieval F1 without reranker: 0.5406
- Generation BLEU: 37.2907
- Generation ROUGE: 0.4386
...
- `audit_missing_evidence` 감사 대응을 위해 지출 증빙이 부족할 때 어떤 위험과 보완 조치가 필요한지 알려줘.
  mode=audit_response categories=['rule' 'guide' 'law'] rouge=0.2609 bleu=21.2396
- `contract_risk_review` 계약 변경 시 반드시 검토해야 할 조항과 위험 포인트를 알려줘.
  mode=contract_review categories=['rule' 'guide' 'law'] rouge=0.2857 bleu=38.0201
- `procurement_quote_rule` 구매 시 비교견적이나 입찰이 필요한 기준을 정리해줘.
  mode=procurement_bid categories=['rule' 'guide' 'law'] rouge=0.3226 bleu=25.4706
