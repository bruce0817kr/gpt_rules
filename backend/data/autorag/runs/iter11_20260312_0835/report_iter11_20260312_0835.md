# Ralph Loop Report iter11_20260312_0835

- Generated at (UTC): 2026-03-12T00:08:18.465924+00:00
- Retrieval F1 with reranker: 1.0000
- Retrieval F1 without reranker: 0.5406
- Generation BLEU: 73.0890
- Generation ROUGE: 0.5122
...
- `contract_risk_review` 계약 변경 시 반드시 검토해야 할 조항과 위험 포인트를 알려줘.
  mode=contract_review categories=['rule' 'guide' 'law'] rouge=0.3333 bleu=77.0668
- `procurement_quote_rule` 구매 시 비교견적이나 입찰이 필요한 기준을 정리해줘.
  mode=procurement_bid categories=['rule' 'guide' 'law'] rouge=0.3704 bleu=81.7777
- `audit_missing_evidence` 감사 대응을 위해 지출 증빙이 부족할 때 어떤 위험과 보완 조치가 필요한지 알려줘.
  mode=audit_response categories=['rule' 'guide' 'law'] rouge=0.4348 bleu=80.9554
