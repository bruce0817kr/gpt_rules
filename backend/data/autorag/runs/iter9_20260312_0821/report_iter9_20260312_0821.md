# Ralph Loop Report iter9_20260312_0821

- Generated at (UTC): 2026-03-11T23:24:20.852795+00:00
- Retrieval F1 with reranker: 1.0000
- Retrieval F1 without reranker: 0.5406
- Generation BLEU: 66.4965
- Generation ROUGE: 0.4486
...
- `corp_card_policy` 법인카드 사용 제한과 증빙 보관 기준을 알려줘.
  mode=audit_response categories=['rule' 'guide' 'notice'] rouge=0.1875 bleu=18.9095
- `contract_risk_review` 계약 변경 시 반드시 검토해야 할 조항과 위험 포인트를 알려줘.
  mode=contract_review categories=['rule' 'guide' 'law'] rouge=0.3333 bleu=76.3080
- `procurement_quote_rule` 구매 시 비교견적이나 입찰이 필요한 기준을 정리해줘.
  mode=procurement_bid categories=['rule' 'guide' 'law'] rouge=0.3704 bleu=80.7545
