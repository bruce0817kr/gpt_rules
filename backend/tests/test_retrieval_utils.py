...
def test_retrieval_window_expands_top_k_for_card_evidence_questions() -> None:
    assert needs_wide_top_k("법인카드 사용 제한과 증빙 보관 기준을 알려줘.") is True

    effective_top_k, candidate_count = retrieval_window(
        "법인카드 사용 제한과 증빙 보관 기준을 알려줘.",
        top_k=5,
        rerank_candidates=12,
    )
